...
@section('content')
<div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-xl bg-white">
  ...
  <div class="block w-full overflow-x-auto">
    ...
    <table class="items-center w-full bg-transparent border-collapse">
      ...
      <tbody>
        ...
        <tr>
          <th class="border-t-0 px-6 align-middle border-l-0 border-r-1 whitespace-nowrap p-4 text-left flex items-center">
          ...
          <td class="border-t-0 px-6 align-middle border-l-0 border-r-1 whitespace-nowrap p-4">
            <a href="{{ route('admin.editUser', $person->id) }}" class="px-4 py-2 text-indigo-500 hover:text-indigo-600">Edit</a>
          </td>
        </tr>
        @endforeach
      </tbody>
