          ...
          <div class="relative flex flex-col min-w-0 break-words bg-white rounded mb-6 xl:mb-0 shadow-lg">
            <div class="flex-auto p-4">
              <div class="flex flex-wrap">
                ...
                <div class="relative w-auto pl-4 flex-initial">
                  <div class="bg-sky-500 text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 shadow-lg rounded-full bg-lightBlue-500">
        ...
        <tbody>
          ...
          <tr>
            <th class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left flex items-center">
              <img src="{{ asset($guru->foto_profile) }}" class="h-12 w-12 bg-white rounded-full border" alt="..." />
