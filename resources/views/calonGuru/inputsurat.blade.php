        ...
        <form action="/surat-surat" method="POST" class="p-5" enctype='multipart/form-data'>
            ...
            <div class="flex flex-col my-3">
                ...
                <div class="flex flex-row border border-green-400 rounded-lg items-center gap-5 pl-3 h-10">
                    ...
                    <a href="{{ asset($surat['lamaran']) }}" class="bg-green-400 w-32 h-10 text-white flex items-center justify-center hover:bg-green-500 cursor-pointer" target="_blank">
                        Lihat
                    </a>
                    @endif
                </div>
                @error('lamaran') <small class="text-red-500">{{ $message }}</small> @enderror
            </div>
            ...
            <div class="flex flex-col my-3">
                ...
                <div class="flex flex-row border border-green-400 rounded-lg items-center gap-5 pl-3 h-10">
                    ...
                    <a href="{{ asset($surat['cv']) }}" class="bg-green-400 w-32 h-10 text-white flex items-center justify-center hover:bg-green-500 cursor-pointer" target="_blank">
                        Lihat
                    </a>
                    @endif
                </div>
                @error('cv') <small class="text-red-500">{{ $message }}</small> @enderror
            </div>
            ...
            <div class="flex flex-col my-3">
                ...
                <div class="flex flex-row border border-green-400 rounded-lg items-center gap-5 pl-3 h-10">
                    ...
                    <a href="{{ asset($surat['ktp']) }}" class="bg-green-400 w-32 h-10 text-white flex items-center justify-center hover:bg-green-500 cursor-pointer" target="_blank">
                        Lihat
                    </a>
                    @endif
                </div>

                @error('ktp') <small class="text-red-500">{{ $message }}</small> @enderror
            </div>
            ...
            <div class="flex flex-col my-3">
                ...
                <div class="flex flex-row border border-green-400 rounded-lg items-center gap-5 pl-3 h-10">
                    ...
                    <a href="{{ asset($surat['ijazah']) }}" class="bg-green-400 w-32 h-10 text-white flex items-center justify-center hover:bg-green-500 cursor-pointer" target="_blank">
                        Lihat
                    </a>
                    @endif
                </div>

                @error('ijazah') <small class="text-red-500">{{ $message }}</small> @enderror
            </div>
            ...
            <div class="flex flex-col my-3">
                ...
                <div class="flex flex-row border border-green-400 rounded-lg items-center gap-5 pl-3 h-10">
                    ...
                    <a href="{{ asset($surat['nilai']) }}" class="bg-green-400 w-32 h-10 text-white flex items-center justify-center hover:bg-green-500 cursor-pointer" target="_blank">
                        Lihat
                    </a>
                    @endif
                </div>
            ...
            <div class="flex flex-col my-3">
                ...
                <div class="flex flex-row border border-green-400 rounded-lg items-center gap-5 pl-3 h-10">
                    ...
                    <a href="{{ asset($surat['photo']) }}" class="bg-green-400 w-32 h-10 text-white flex items-center justify-center hover:bg-green-500 cursor-pointer" target="_blank">
                        Lihat
                    </a>
                    @endif
                </div>
            ...
            <div class="flex flex-col my-3">
                ...
                <div class="flex flex-row border border-green-400 rounded-lg items-center gap-5 pl-3 h-10">
                    ...
                    <a href="{{ asset($surat['pengalaman_kerja']) }}" class="bg-green-400 w-32 h-10 text-white flex items-center justify-center hover:bg-green-500 cursor-pointer" target="_blank">
                        Lihat
                    </a>
                    @endif
                </div>

                @error('pengalaman_kerja') <small class="text-red-500">{{ $message }}</small> @enderror
            </div>
            ...
            <div class="flex flex-col my-3">
                ...
                <div class="flex flex-row border border-green-400 rounded-lg items-center gap-5 pl-3 h-10">
                    ...
                    <a href="{{ asset($surat['sertifikat_pendukung']) }}" class="bg-green-400 w-32 h-10 text-white flex items-center justify-center hover:bg-green-500 cursor-pointer" target="_blank">
                        Lihat
                    </a>
                    @endif
                </div>

                @error('sertifikat_pendukung') <small class="text-red-500">{{ $message }}</small> @enderror
            </div>

            <div class="flex justify-center">
                <button type="submit" class="mt-10 bg-green-400 py-2 px-5 rounded-md cursor-pointer text-white shadow-xl hover:bg-green-600">Submit</button>
            </div>
        </div>
      </div>
    </section>
